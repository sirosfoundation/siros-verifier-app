...
void main() {
  ...
  group('HomeScreen', () {
    ...
    testWidgets('shows footer tagline', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: HomeScreen()));
      expect(find.text('Secure · Privacy-preserving · ISO compliant'),
          findsOneWidget);
    });
  ...
  group('ResultScreen', () {
    testWidgets('displays credential fields', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: ResultScreen(fields: const {
          'given_name': 'Alice',
          'family_name': 'Smith',
    ...
    testWidgets('shows verification status', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: ResultScreen(fields: const {'given_name': 'Test'}),
      ));

      expect(find.text('Credential Verified'), findsOneWidget);
      expect(
          find.text('ISO 18013-5 mDL · Proximity'), findsOneWidget);
    });
